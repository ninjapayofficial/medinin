...
//   const Anatomy3DModelViewer(
//       {Key? key, required this.modelName, required this.modelUrl})
//       : super(key: key);
...
//       String modelPath = await _loadModel(widget.modelName);
//       _webViewController.loadUrl('file://$modelPath');
//     });
//   }
...
//                 String modelPath = await _loadModel(entry.key);
//                 _webViewController.loadUrl('file://$modelPath');
//               },
//             );
//           }).toList(),
...
//   Future<String> _loadModel(String modelName) async {
//     String? modelPath = await _databaseHelper.getModelLocalPath(modelName);

//     if (modelPath == null) {
//       String url = models[modelName]!;
//       modelPath = await _databaseHelper.downloadAndSaveModel(url, modelName);
//     }
//     return modelPath;
//   }
// }
